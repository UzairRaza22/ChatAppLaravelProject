...
Route::middleware(['check.token:login_token', 'check.active'])->group(function () {
    ...
    Route::post('/channels/read', [ChannelController::class, 'read'])
        ->middleware('check.validation:ReadChannelRequest')
        ->middleware(ChannelExistMiddleware::class);

    Route::post('/channels/list-by-user', [ChannelController::class, 'listByUser'])
    ...
    Route::post('/channels/add-member', [ChannelController::class, 'addMember'])
    ...
    Route::post('/channels/remove-member', [ChannelController::class, 'removeMember'])
